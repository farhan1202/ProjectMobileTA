...
//    public static final String BASE_URL1 = "http://52.204.60.245/API_PEMILU/";  //hostingan di 000webhost,com
    public static final String BASE_URL = "http://35.174.155.66/pemilu/api/";  //hostingan AWS
    public static final String BASE_URL1 = "http://35.174.155.66/pemilu/";  //hostingan AWS
